...
* I fixed the CRAN NOTE: "Found calls to structure() using deprecated special names: ClusterR/tests/testthat/test-gmm.R (.Dim: 2, .Names: 1) '.Dim' should be changed to 'dim'. '.Names' should be changed to 'names'."
